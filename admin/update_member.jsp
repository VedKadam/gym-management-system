...
<html>
<head>
<title> Update Member Module</title>
...
<body>
        ...
        <li><a href="#">Membership <i class="fas fa-caret-down"></i></a>
            ...
            <div class="dropdown-menu">
                <ul>
				  ...
				  <li><a href="admin/update_member.jsp">Update Members</a></li>
	...
	<form method="post">
		...
		try
		{
			...
			String sql="UPDATE users SET username=?, password=?, email=?, membership=? WHERE id=?";
			PreparedStatement pst = con.prepareStatement(sql);
			
			pst.setString(1, username);
			pst.setString(2, password);
			pst.setString(3, email);
			pst.setString(4, membership); // Set membership value as a string
			pst.setInt(5, mid);
	...
	if (password.length() < 8 || !password.matches(".*[a-z].*") || !password.matches(".*[A-Z].*")
        ...
        out.println("Password must be at least 8 characters long and contain at least one lowercase letter, one uppercase letter, one digit, and one special character (!@#$%^&*)");
				...
				pst.executeUpdate();
			out.println(username + " Member Details Updated");	
	}	
