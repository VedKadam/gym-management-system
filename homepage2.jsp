...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Cormorant+SC:wght@700&family=Wallpoet&display=swap" rel="stylesheet"> <!-- overall font --> 
...
<title> Premium Member Module </title>
...
<body>	
	...
	<center> 
			...
			<div class="dropdown mt-4 mx-5" >
				...
				<ul class="dropdown-menu">
				  ...
				  <li><button class="dropdown-item" type="button"><a class="p-1" href="" style="text-decoration: none ; background-color: #fffffe; color: black ; font-weight: bold ;">
					<%
					if(session.getAttribute("premium")!=null)
					{
						String user=(String)session.getAttribute("premium");
		...
		<h1 class="gym-name gym-name-large"> The Rock Fitness and More </h1>
		
	</header>
		<h2 class="h2E"> You are an Premium Member</h2>
		<br>
		<br>
	</center>
	...
	<input type="date" name="date" class="date" min="2023-04-27" required>

	<input type="submit" value="Submit" name="btn1" class="btn1" />
